        ...
        <div className="total-count-item">
            { item &&
                <div className="total-count-item-container">
                    <div className={`headerbox count ${item.color} flex-center-dashboard`}>
                        <FontAwesomeIcon icon={item.icon} className="icon" />
                    </div>
                    <div className="total-count-header flex-center-dashboard">
                        <p>{item.title}</p>
                    </div>
                    ...
                    {
                        item.isDecrease &&
                        <div className="count-status flex-center-dashboard">
