...
describe('LOGIN', () => {
    ...
    const valueBoard = [
        ...
        { case: 'Username invalid && Password is null', username: 'admin', password: '', result: 'Password is valid' },
        { case: 'Username is null && Password invalid', username: '', password: 'Matkhau1', result: 'Username is valid' },
    ]
    valueBoard.map(item => (
        it(item.case, async () => {
