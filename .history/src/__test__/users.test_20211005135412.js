...
describe('LOGIN', () => {
    ...
    const valueBoard = [
        ...
        { case: 'Username is null && Password is null', username: '', password: '', result: 'Username and Password INVALID' },
        { case: 'Username VALID && Password is null', username: 'admin', password: '', result: 'Password is valid' },
        { case: 'Username is null && Password VALID', username: '', password: 'Matkhau1', result: 'Username is valid' },
        { case: 'Username INVALID && Password INVALID with space', username: '     ', password: '      ', result: 'Username INVALID' },
        { case: 'Username VALID && Password VALID', username: 'adm in', password: 'Mat khau1', result: 'Username and Password INVALID' },
        { case: 'Account login FAILD with case LENGTH INVALID', username: 'ad', password: '1', result: 'Username and Password INVALID' },
        { case: 'Username INVALID && Password INVALID with symbox', username: '!32$%@  **', password: '()1#~~4)', result: 'Username and Password INVALID' },
    ]
    valueBoard.map(item => (
        it(item.case, async () => {
