...
describe('LOGIN', () => {
    const user = new Users();
    const valueBoard = [
        { case: 'Username VALID && Password VALID', username: 'admin', password: 'Matkhau1', result: 'Username and Password is valid' },
        { case: 'Username is null && Password is null', username: '', password: '', result: 'Username is valid' },
