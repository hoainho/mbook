...
describe('LOGIN', () => {
    ...
    const valueBoard = [
        ...
        { case: 'Username is INVALID && Password is INVALID with space', username: '     ', password: '      ', result: 'Username is INVALID' },
        { case: 'Username is INVALID && Password is INVALID with symbox', username: '!32$%@  **', password: '()1#~~4)', result: 'Username and Password is INVALID' },
    ]
    valueBoard.map(item => (
        it(item.case, async () => {
