...
describe('LOGIN', () => {
    ...
    const valueBoard = [
        ...
        { case: 'Username VALID && Password VALID', username: 'adm in', password: 'Mat khau1', result: 'Username INVALID' },
        { case: 'Account login FAILD with case LENGTH INVALID', username: 'ad', password: '1', result: 'Username INVALID' },
        { case: 'Username INVALID && Password INVALID with symbox', username: '!32$%@  **', password: '()1#~~4)', result: 'Username INVALID' },
    ]
    valueBoard.map(item => (
        it(item.case, async () => {
