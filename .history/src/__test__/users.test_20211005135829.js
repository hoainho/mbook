...
describe('LOGIN', () => {
    ...
    const valueBoard = [
        ...
        { case: 'Username VALID && Password is null', username: 'admin', password: '', result: 'Password INVALID' },
        { case: 'Username is null && Password VALID', username: '', password: 'Matkhau1', result: 'Username INVALID' },
