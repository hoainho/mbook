...
describe('UPDATE ACCOUNT', () => {
    it('Self Account', async () => {
        const user = new Users();
        var res = await user.changeStatus("e4e91fc8-c007-4aa5-b225-f9be24f66cfe", { status: true }, { Authorization: `Bearer-eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJkZXYiLCJleHAiOjE2MzMzMTMxMTgsImlhdCI6MTYzMzI3NzExOH0.P_1x5zc11TuRbUmS2-wJnQzPy7jbTJFu7O7RnalCuhk` })
    ...
    it('Other Account ( ROLE USER )', async () => {
        const user = new Users();
        var res = await user.changeStatus("e4e91fc8-c007-4aa5-b225-f9be24f66cfe", { status: true }, { Authorization: `Bearer-eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJiYW5nbGFuZ3RpbSIsImV4cCI6MTYzMzMxMzE2OSwiaWF0IjoxNjMzMjc3MTY5fQ.O8Pk4R9hOGQs1Pa4of3cigFWp4LZ8Ze-jq4Zrs5Wg4A` })
        expect(res.data).toBe(true);
    });
